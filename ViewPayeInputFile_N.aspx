<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ViewPayeInputFile_N.aspx.cs" Inherits="ViewPayeInputFile_N" %>
        ...
        <div id="divmsg" class="" runat="server" style="display:none"></div>
         ...
         <div>
            <table class="table borderless" style="width:100% !important; border:none !important;">
                  <tr>
                      <td style="font-weight:bold;">Employee Name:</td> <td></td><td><asp:TextBox ID="txt_employee_name" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                      <td style="font-weight:bold;">Employee TIN:</td> <td></td><td><asp:TextBox ID="txt_employee_TIN" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                </tr>
                <tr>
                    ...
                    <td style="font-weight:bold;">Employee RIN:</td> <td></td><td><asp:TextBox ID="txt_employee_RIN" runat="server" CssClass="form-control" Enabled="false"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="font-weight:bold;">Annual Basic:</td> <td></td><td><asp:TextBox ID="txt_AnnualBasic" runat="server" CssClass="form-control" Text="0" Enabled="false"></asp:TextBox></td>
                    <td style="font-weight:bold;">Annual Rent:</td> <td></td><td><asp:TextBox ID="txt_AnnualRent" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="font-weight:bold;">Annual Transport:</td> <td></td><td><asp:TextBox ID="txt_Annual_Trans" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                    <td style="font-weight:bold;">Annual Utility:</td> <td></td><td><asp:TextBox ID="txt_Annual_Utility" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="font-weight:bold;">Annual Meal:</td> <td></td><td><asp:TextBox ID="txt_Annual_Meal" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                    <td style="font-weight:bold;">Leave Transport Grant:</td> <td></td><td><asp:TextBox ID="txt_Leave_Trans_Grant" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                </tr>
                <tr>
                    <td style="font-weight:bold;">Pension:</td> <td></td><td><asp:TextBox ID="txt_Pension" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                    <td style="font-weight:bold;">NHF:</td> <td></td><td><asp:TextBox ID="txt_NHF" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                </tr>

                 <tr>
                    <td style="font-weight:bold;">NHIS:</td> <td></td><td><asp:TextBox ID="txt_NHIS" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                 ...
                 <tr>
                    <td style="font-weight:bold;">Other Income:</td> <td></td><td><asp:TextBox ID="txt_otherIncome" runat="server" CssClass="form-control"  Text="0" Enabled="false"></asp:TextBox></td>
                 ...
                 <cc1:CalendarExtender ID="cal_start_date" TargetControlID="txt_start_month" Format="yyyy-MM-dd" runat="server"></cc1:CalendarExtender>--%>
                        ...
                        <asp:DropDownList ID="txt_start_month" runat="server" CssClass="form-control" Enabled="false">
                    ...
                    <td style="font-weight:bold;">End Month:</td> <td></td><td>
                        ...
                        <cc1:CalendarExtender ID="cal_end_date" TargetControlID="txt_end_month" Format="yyyy-MM-dd" runat="server"></cc1:CalendarExtender>--%>
                         ...
                         <asp:DropDownList ID="txt_end_month" runat="server" CssClass="form-control" Enabled="false">
