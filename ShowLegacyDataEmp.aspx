<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ShowLegacyDataEmp.aspx.cs" Inherits="ShowLegacyDataEmp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentheading" Runat="Server">
     Manage Employees (<asp:Label ID="lbl_employername" runat="server" Text=""></asp:Label>) - PAYE Ouput File
</asp:Content>
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                       <%-- <a id="A1" data-toggle="modal" data-target="#divTaxPayerModal" onclick="gf();" runat="server">View Paye detail</a>--%>
                                                        <asp:LinkButton PostBackUrl= '<%#"~/ViewOutputFile_N.aspx?compRIN="+Eval("CompanyRIN")+"&empRIN="+Eval("taxpayerRIN")+"&empTIN="+Eval("tp_tin")+"&TaxYear="+Eval("tax_year")%>' runat="server" ID="LinkButton1"> View Paye Details </asp:LinkButton>
