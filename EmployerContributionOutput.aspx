    ...
    <ContentTemplate> 
         ...
         <div>
            ...
            <asp:Button ID="btnExcel" Text="Save AS Excel"  CssClass="btn btn-theme" runat="server" OnClick="btnExcel_Click" />
                ...
                <tr style="display:none;">
                    <td>Employer RIN:</td> <td></td><td><asp:TextBox ID="txt_tax_payer_RIN" runat="server" CssClass="form-control"></asp:TextBox></td>
                </tr>

                <tr style="display:none;">
                    <td>Employer Name:</td> <td></td><td><asp:TextBox ID="txt_tax_payer_name" runat="server" CssClass="form-control"></asp:TextBox></td>
                </tr>
                <tr style="display:none;">
      ...
      <div class="portlet-title">
       ...
       <asp:BoundField DataField="EmployerName" HeaderText="Employer Name"  />          
               <asp:BoundField DataField="TaxPayerRin" HeaderText="Business RIN"  /> 
