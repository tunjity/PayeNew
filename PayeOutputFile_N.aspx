<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PayeOutputFile_N.aspx.cs" Inherits="PayeOutputFile_N" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        function Confirm() {
            ...
            if (confirm("Do you want to change status as Successful?")) {
                confirm_value.value = "";
