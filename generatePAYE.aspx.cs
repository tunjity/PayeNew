...
public partial class generatePAYE : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            SqlDataAdapter Adp = new SqlDataAdapter("select distinct CompanyRIN, CompanyName, ContactAddress from vw_InputFile where TaxMonth='January'", con);
