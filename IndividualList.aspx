<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="IndividualList.aspx.cs" Inherits="IndividualList" %>
             ...
             <ItemTemplate>
              ...
              <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <asp:LinkButton PostBackUrl= '<%#"~/TaxPayerDetails.aspx?name="+Eval("TaxPayerName")+"|"+"Ind"+"|"+Eval("ContactAddress")+"|"+Eval("Tin")+"|"+Eval("TaxPayerRIN")+"|"+Eval("MobileNumber")%>' runat="server" ID="lnkDetails"> Tax Payer Details </asp:LinkButton>
                                                    </li>
                                                </ul>
                                            </div>
        </ItemTemplate>
