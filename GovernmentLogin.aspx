<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GovernmentLogin.aspx.cs" Inherits="GovernmentLogin" %>
 ...
 <form id="frm1" runat="server">
    ...
    <section class="alternate">
        <div class="container">
            ...
            <div class="title">
                <h1>
                    Login as a Tax Payer - Government
                </h1>
                <hr>
                <p>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                Log into ERAS as Tax Payer - Government
                            </div>
                        </div>
                        <div class="portlet-body ">
                            <div class="row">
