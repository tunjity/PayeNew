...
80, NEW LAGOS ROAD, BENIN CITY--%>
         ...
         <table align="center" style="width:100%">
                    <tr><td> <img alt="" src="https://pinscher.eirsautomation.xyz/rsps/paye-ctec/logo/coat_of_arm.png" height="70" width="70" /></td> 
                    <td  align="center"><b> EDO STATE INTERNAL REVENUE SERVICE <br />
80, NEW LAGOS ROAD, BENIN CITY</b></td>
                       
                        <td><img alt="" src="https://pinscher.eirsautomation.xyz/rsps/paye-ctec/logo/eirs_logo.png" height="70" width="70" /></td></tr>
                </table>
    </div>
</div>
       ...
       <div id="main" runat="server">
            ...
            <div class="caption" style="width:100%; display:none;">
                <table style="width:100%">
                    <tr><td> <img alt=""src="https://pinscher.eirsautomation.xyz/rsps/paye-ctec/logo/coat_of_arm.png" height="70" width="70" /></td> 
                 <td></td> <td></td> <td  id="HeadingDiv"   runat="server" colspan="3" align="center"> <b>EDO STATE INTERNAL REVENUE SERVICE <br />
80, NEW LAGOS ROAD, BENIN CITY</b></td> <td></td><td></td>
                       
                        <td align="right" style="width:100px;"><img alt="" src="https://pinscher.eirsautomation.xyz/rsps/paye-ctec/logo/eirs_logo.png" height="70" width="70" /></td></tr>
                </table>
...
<td style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;width:30%;">
         ...
         <div  class="portlet light" align="center">
             ...
             <table id="t1" runat="server" border="1" class="table" style="width:95% !important; border:solid;border-width:2px; border-color:lightsteelblue;">
                 <tr style="border:solid;border-width:2px; border-color:lightsteelblue; ">
                     ...
                     <td  style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><asp:Label ID="lbl_tax_payer_name" runat="server"  ></asp:Label></td>
                 </tr>

                 <tr>
                     <td  style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><b>BUSINESS NAME:</b></td>
                     <td  style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><asp:Label ID="lbl_business_name" runat="server"  ></asp:Label></td>
                 </tr>
                 <tr>
                     <td  style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><b>ADDRESS:</b></td>
                     <td  style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><asp:Label ID="lbl_address" runat="server"  ></asp:Label></td>
                 </tr>
             ...
             <table class="table" border="1" style="width:100% !important; border:solid;border-width:2px; border-color:lightsteelblue;">
                 <tr>
                     ...
                     <td style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><asp:Label ID="lbl_tax_payer_RIN" runat="server"  ></asp:Label></td>
                 </tr>

                 <tr>
                     <td style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><b>BUSINESS RIN:</b></td>
                     <td style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><asp:Label ID="lbl_business_RIN" runat="server"  ></asp:Label></td>
                 </tr>
                 <tr>
                     <td style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><b>PHONE:</b></td>
                     <td style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;"><asp:Label ID="lbl_phone" runat="server"  ></asp:Label></td>
                 </tr>
...
<td style="text-align:left;border:solid;border-width:2px; border-color:lightsteelblue;width:30%;">
      ...
      <div class="portlet-title">
                 ...
                 <div class="caption" style="width:100%; text-align:center;"> <b> <asp:Label ID="lbl_year" runat="server"></asp:Label> &nbsp;&nbsp;  PAYE TAX ANALYSIS <br /><br />
            </b></div>
          </div>
        ...
        AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover"  HeaderStyle-CssClass="GridHeader" ShowFooter="true">
         ...
         <Columns>
             ...
             <asp:BoundField ItemStyle-Width="9" DataField="EmployeeRIN" HeaderText="RIN" />
             <asp:BoundField  ItemStyle-Width="15"  DataField="names" HeaderText="Name" />           
         ...
         <PagerStyle CssClass="pagination-ys" HorizontalAlign="Right" />
                ...
                <div style="margin-top:-60px;margin-left:10px;display:none;" visible="false" id="div_paging" runat="server">Showing <asp:Label runat="server" ID="lblpagefrom"></asp:Label> - <asp:Label runat="server" ID="lblpageto"></asp:Label> entries of <asp:Label runat="server" ID="lbltoal"></asp:Label> entries</div>
                </div>
